package com.mydashboard.athena.flink.job;
...
public class FlinkReadWriteKafkaJSON {
	...
	private static final Logger LOG = LoggerFactory.getLogger(FlinkReadWriteKafkaJSON.class);
	...
	public static void main(String[] args) throws Exception {
		...
		LOG.info("++++ FlinkReadWriteKafkaJSON job start run... ++++");
		System.out.println("FlinkReadWriteKafkaJSON job start run...");
		...
		env.getConfig().setGlobalJobParameters(globalParam); // make parameters available in the web interface
		env.setStreamTimeCharacteristic(TimeCharacteristic.EventTime);
		
		LOG.info("@@@@@@ FlinkReadWriteKafkaJSON job DataStream start run... @@@@@");
		System.out.println("FlinkReadWriteKafkaJSON job DataStream start run...");

		DataStream<KafkaEvent> input = env
				.addSource(
					new FlinkKafkaConsumer010<>(
						globalParam.getRequired("input-topic-synthetic"),
		...
		input.addSink(
				new FlinkKafkaProducer010<>(
						globalParam.getRequired("output-topic-synthetic"),
						new KafkaEventSchema(),
						globalParam.getProperties()));
		
		LOG.info("****** FlinkReadWriteKafkaJSON job DataStream done... *****");
		System.out.println("FlinkReadWriteKafkaJSON job DataStream done...");
		
		env.execute("Kafka 0.10 Example");
		
		LOG.info("$$$$$$$$$$$$$ FlinkReadWriteKafkaJSON job done... $$$$$$$$$");
		System.out.println("FlinkReadWriteKafkaJSON job done...");
