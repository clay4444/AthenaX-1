...
import com.uber.athenax.backend.api.client.auth.Authentication;
...
public class ApiClient {
  ...
  //private String basePath = "http://localhost:8083/ws/v1";
  private String basePath = "http://localhost:8083/mydashboard";
  //private String basePath = "http://10.163.134.152:8083/mydashboard";
  ...
  private ClientResponse getAPIResponse(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String accept, String contentType, String[] authNames) throws ApiException {
	  LOG.info("Inside the getAPIResponse method.. START...");
    ...
    LOG.info("Builder  Object : {}",builder);
